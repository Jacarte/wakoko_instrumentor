...
if (ENVIRONMENT_IS_NODE) {
  if (ENVIRONMENT_IS_WORKER) {
    scriptDirectory = require('../../wakoko-browser/emcc/node_modules/path').dirname(scriptDirectory) + '/';
  } else {
...
read_ = function shell_read(filename, binary) {
  if (!nodeFS) nodeFS = require('../../wakoko-browser/emcc/node_modules/fs');
  if (!nodePath) nodePath = require('../../wakoko-browser/emcc/node_modules/path');
...
// {{PRE_LIBRARY}}
  ...
  function getRandomDevice() {
      ...
      if (ENVIRONMENT_IS_NODE) {
        ...
        try {
          var crypto_module = require('../../wakoko-browser/emcc/node_modules/crypto');
