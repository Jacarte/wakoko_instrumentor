(module
  ...
  (type (;15;) (func (param f64 i32) (result i32)))
  (type (;16;) (func (param f64 f64 i32) (result f64)))
  (type (;17;) (func (param f64 f64 f64 f64 f64) (result f64)))
  (type (;18;) (func (param i32 i32 f64 f64 i32)))
  (type (;19;) (func (param f64 i32 f64 f64 i32) (result f64)))
  ...
  (func $malloc_usable_size (type 5) (param i32) (result i32)
    ...
    local.get 1)
  (func $__main_argc_argv (type 4) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $main)
  ...
  (func $puts (type 5) (param i32) (result i32)
    ...
    i32.const 31
    i32.shr_s)
  (func $__cos (type 14) (param f64 f64) (result f64)
    (local f64 f64 f64)
    f64.const 0x1p+0 (;=1;)
    local.get 0
    local.get 0
  ...
  (func $scalbn (type 11) (param f64 i32) (result f64)
    ...
    f64.reinterpret_i64
    f64.mul)
  (func $__rem_pio2_large (type 12) (param i32 i32 i32 i32 i32) (result i32)
    ...
    i32.const 7
    i32.and)
  (func $__rem_pio2 (type 15) (param f64 i32) (result i32)
    ...
    global.set 0
    local.get 5)
  (func $__sin (type 16) (param f64 f64 i32) (result f64)
    (local f64 f64 f64)
    local.get 0
    local.get 0
    f64.mul
  ...
  (func $cos (type 2) (param f64) (result f64)
    ...
    global.set 0
    local.get 3)
  (func $test_func (type 2) (param f64) (result f64)
    local.get 0
    call $cos)
  (func $map (type 17) (param f64 f64 f64 f64 f64) (result f64)
    local.get 0
    local.get 1
    f64.sub
    local.get 2
    ...
    local.get 3
    f64.add)
  (func $cheb_coef (type 18) (param i32 i32 f64 f64 i32)
    (local i32 i32 f64 f64 f64 f64 i32)
    i32.const 0
    local.set 5
    local.get 4
    i32.const 0
  ...
  (func $cheb_approx (type 19) (param f64 i32 f64 f64 i32) (result f64)
    (local f64 f64)
    local.get 4
    f64.load
    f64.const 0x1p-1 (;=0.5;)
  ...
  (func $__original_main (type 10) (result i32)
    ...
    loop  ;; label = @1
      ...
      f64.add
      local.tee 6
      f64.const -0x1.dbbfc5dfbf84p-3 (;=-0.232299;)
      f64.mul
      f64.const 0x1.a5ace613c5581p-1 (;=0.823585;)
      f64.add
      local.get 6
      local.get 6
      f64.add
      ...
      f64.add
      local.tee 8
      f64.const -0x1.b808c2934863p-5 (;=-0.0537151;)
      f64.mul
      f64.add
      local.get 7
      local.get 8
      ...
      f64.sub
      local.tee 6
      f64.const 0x1.4234b027b604p-9 (;=0.00245824;)
      f64.mul
      f64.add
      local.get 7
      local.get 6
      ...
      f64.sub
      local.tee 8
      f64.const 0x1.27d2c2010e2p-12 (;=0.000282119;)
      f64.mul
      f64.add
      local.get 7
      local.get 8
      ...
      f64.sub
      local.tee 6
      f64.const -0x1.031d717fep-17 (;=-7.72223e-06;)
      f64.mul
      f64.add
      local.get 7
      local.get 6
      ...
      f64.sub
      local.tee 8
      f64.const -0x1.3cad24842p-21 (;=-5.89856e-07;)
      f64.mul
      f64.add
      local.get 7
      local.get 8
      ...
      f64.sub
      local.tee 6
      f64.const 0x1.8bdf8cep-27 (;=1.15214e-08;)
      f64.mul
      f64.add
      local.get 7
      local.get 6
      ...
      f64.sub
      local.tee 8
      f64.const 0x1.6aa2b2p-31 (;=6.5963e-10;)
      f64.mul
      f64.add
      local.get 7
      local.get 8
      ...
      local.get 6
      f64.sub
      f64.const -0x1.609d6p-37 (;=-1.00219e-11;)
      f64.mul
      f64.add
      local.tee 7
      f64.store
  ...
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  (global (;0;) (mut i32) (i32.const 73744))
  (global (;1;) i32 (i32.const 8196))
  (global (;2;) i32 (i32.const 1024))
  (global (;3;) i32 (i32.const 73744))
  ...
  (global (;16;) i32 (i32.const 2864))
  (global (;17;) i32 (i32.const 2744))
  (global (;18;) i32 (i32.const 4536))
  ...
  (export "map" (func $map))
  (export "cheb_coef" (func $cheb_coef))
  (export "cheb_approx" (func $cheb_approx))
